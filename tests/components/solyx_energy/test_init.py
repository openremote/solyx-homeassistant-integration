...
async def test_config_entry_auth_failure(hass: HomeAssistant, mock_config_entry, mock_api_client_class) -> None:
...
async def test_config_entry_not_ready(hass: HomeAssistant, mock_config_entry, mock_api_client_class, api_error) -> None:
