...
async def test_token_refresh_success(aioclient_mock, mock_session):
...
async def test_token_refresh_auth_error(aioclient_mock, mock_session):
...
async def test_get_asset_data_success(aioclient_mock, client):
...
async def test_get_asset_data_error(aioclient_mock, client):
...
async def test_set_asset_attribute_success(aioclient_mock, client):
...
async def test_set_asset_attribute_error(aioclient_mock, client):
