"""Response parsing helpers for the Solyx Energy API."""
...
def parse_attr_value(raw: dict[str, Any], attr_name: str) -> Any:  # noqa: ANN401
    """Extract a value from a Solyx Energy device attribute."""
...
def parse_float(raw: dict[str, Any], attr_name: str) -> float | None:
    """Parse a float value from a Solyx Energy device attribute."""
