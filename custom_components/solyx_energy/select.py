...
class SolyxSelectEntity(SolyxNymoEntity, SelectEntity):
    ...
    def __init__(self, coordinator: SolyxEnergyCoordinator, description: SolyxSelectEntityDescription) -> None:
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        await self.coordinator.async_set_attribute(self.entity_description.key, self._values_map[option])
